        ...
        <main>
            <form id="form1" runat="server" class="form-horizontal">
                ...
                <div class="form-group">
                    <div class="col-sm-7">
                        <!-- multiline text box -->
                    <asp:TextBox ID="txtSpecialRequests" runat="server" TextMode="MultiLine" Rows="4" CssClass="form-control"></asp:TextBox>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <!-- text box -->
                        <asp:TextBox ID="txtTelephone" runat="server" TextMode="Phone" CssClass="form-control"></asp:TextBox>
                    </div>
                </div>
                <div class="form-group">
